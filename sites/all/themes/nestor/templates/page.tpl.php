...
<div class="main-wrapper <?php print $layout_version; ?>">
  ...
  */?>
  ...
  <!-- SOF Product Categories Highlight -->
  <?php if ($page['iwf_product_category_header']) : ?>
  <div class="product-category-highlight">
    <?php print render($page['iwf_product_category_header']); ?>
  </div>
  <?php endif; ?>
  <?php if ($page['acf_product_category_header']) : ?>
    <div class="product-category-highlight">
      <?php print render($page['acf_product_category_header']); ?>
    </div>
  <?php endif; ?>
  <?php if ($page['ewf_product_category_header']) : ?>
    <div class="product-category-highlight">
      <?php print render($page['ewf_product_category_header']); ?>
    </div>
  <?php endif; ?>
  <?php if ($page['hchc_product_category_header']) : ?>
    <div class="product-category-highlight">
      <?php print render($page['hchc_product_category_header']); ?>
    </div>
  <?php endif; ?>
  <!-- EOF Product Categories Highlight -->
  ...
  <?php if ($page['highlighted_2_1']) : ?>
      <div id="highlighted-2-1-region" class="highlighted region-0 block-0 " <?php print $h2_parallax_ratio; print $h2_parallax_offset; ?>>
        <?php if (isset($highlighted_2_1_wide) && $highlighted_2_1_wide === "off") : ?>
            <div class="container">
              <?php print render($page['highlighted_2_1']); ?>
            </div>
        <?php else : ?>
          <?php print render($page['highlighted_2_1']); ?>
        <?php endif; ?>
  ...
  <!-- SOF Contact regions-->
  <?php if ($page['contact_page_address_and_map'] || $page['contact_page_form']) : ?>
    <div class="contact-region">

      <div class="container">
        <div class="contact-page view-header">
          <h2>Let's keep <span>in touch</span></h2>
        </div>
        <div class="row">
          <div class="col-sm-6">
            <?php print render($page['contact_page_form']); ?>
          </div>
          <div class="col-sm-6">
            <?php print render($page['contact_page_address_and_map']); ?>
          </div>
