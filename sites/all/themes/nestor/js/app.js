(function ($) {
  ...
  $(document).ready(function() {
    ...
    // This override the default beautiful filter transition
    $('.filter').click(function() {
      var activeClass = $(this).attr('data-filter');
      if(activeClass == 'all'){
        $('.mix').css({'display':'inline-block','opacity':'1', '-webkit-transition': 'all 0.3s ease-out','-moz-transition': 'all 0.3s ease-out','-o-transition': 'all 0.3s ease-out','transition': 'all 0.3s ease-out'}).fadeIn();
      } else {
        $('.mix').css({'display':'none','opacity':'0','-webkit-transition': 'all 0.3s ease-out','-moz-transition': 'all 0.3s ease-out','-o-transition': 'all 0.3s ease-out','transition': 'all 0.3s ease-out'}).fadeOut();

        $('.'+activeClass).css({'display':'inline-block','opacity':'1', '-webkit-transition': 'all 0.3s ease-out','-moz-transition': 'all 0.3s ease-out','-o-transition': 'all 0.3s ease-out','transition': 'all 0.3s ease-out'}).fadeIn();
      }
